...
import { Product, ProductService } from './idashboard_temp';
import { LayoutService } from './idashboard_temp_nd';
...
export class Dashboard implements OnInit {
    ...
    constructor(private productService: ProductService, public layoutService: LayoutService, private servicio : AuthService, private router : Router) {}
