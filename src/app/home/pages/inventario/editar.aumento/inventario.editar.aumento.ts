...
@Component({
    selector: 'editar-inventario-aumento',
    templateUrl: 'inventario.editar.aumento.html',
    styleUrl: 'inventario.editar.aumento.css',
    standalone: true,
    imports: [PrimeNgModule, CommonModule],
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class EditarInventarioAumento implements OnInit {
    ...
    OnSubmit() {
        ...
        Swal.fire({
            title: `Va a aumentar ${this.formInventario.controls['cantidad'].value} ton CO2e`,
            ...
            if (result.isConfirmed) {
                ...
                this.srv.actualizaInventarioAumento(inventario).subscribe({
                    next : (respuesta) => {
    ...
    cantidadNoPermitida() : boolean {
        ...
        if(this.comprometido == 0) return false;
